    ...
    def send_file_msg_by_uid(self, fpath, uid):
        ...
        data = {
            ...
            'Msg': {
                'Type': 6,
                'Content': (
                "<appmsg appid='wxeb7ec651dd0aefa9' "
                "sdkver=''><title>%s</title><des></des><action></action><type>6</type><content></content><url></url"
                "><lowurl></lowurl><appattach><totallen>%s</totallen><attachid>%s</attachid><fileext>%s</fileext"
